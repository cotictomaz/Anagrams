 ...
 * BigInteger permutationsPossible =
 * factorial(wordLowerCase.length());//numberOfPermutations(wordLowerCase);
 * if (BigInteger.valueOf(n).compareTo(permutationsPossible) >= 0) {
 * System.out.println("There aren't " + n +
 * " anagrams of the given word. You will get the "
 ...
 * }
 * 
 * private static void printAnagrams(String word, String anagramToPrint, int[]
 * contatore) {
 * if (contatore[0] == 0) {
 * System.exit(0);
 * }
